                ...
                transition-all outline-none pr-12"
                        ...
                        <Link to="/cart" className="relative">
                            <Button
                                variant="outline"
                                size="icon"
                                className="rounded-full border-primary text-primary hover:bg-primary hover:text-white cursor-pointer transition-colors"
                            >
                        ...
                        {user ? (
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        className="gap-2 border-primary text-primary hover:bg-primary hover:text-white cursor-pointer transition-colors"
                                    >
                                ...
                                <DropdownMenuContent align="end" className="w-48">
                                    ...
                                    <DropdownMenuItem
                                        onClick={onLogout}
                                        className="text-red-600 cursor-pointer hover:bg-red-500 hover:text-white transition-colors"
                                    >
                            ...
                            <div className="flex gap-2">
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="border-primary text-primary hover:bg-primary hover:text-white cursor-pointer transition-colors"
                                ...
                                <Button
                                    size="sm"
                                    className="bg-primary hover:bg-primary-focus text-white cursor-pointer transition-colors"
