...
import { DollarSign, Users, Package, TrendingUp, FileBarChart } from 'lucide-react';
...
const ManagerDashboard = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            setLoading(true);
            try {
                const data = await getManagerDashboard(currentLocationId);
                setStats({
        ...
        <div className="flex-1 p-6 bg-base-200 overflow-y-auto">
            <div className="max-w-7xl mx-auto space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <h1 className="text-2xl font-bold text-base-content">Tổng quan - Manager</h1>
                    <Link
                        to="/manager/reports"
