...
const StaffDashboard = () => {
    // Đã gộp các biến lấy từ useAuthStore lại để tránh trùng lặp
    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            ...
            {/* --- HEADER --- */}
            <div className='bg-gradient-to-r from-primary via-primary/95 to-secondary text-primary-content px-6 py-4 shadow-lg flex justify-between items-center'>
            ...
            {/* --- CONTENT AREA --- */}
            <div className='w-full space-y-8 animate-fade-in p-6'>
