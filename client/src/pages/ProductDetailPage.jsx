                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                                    ...
                                    <div className='relative aspect-square bg-white border rounded-xl flex items-center justify-center p-4 overflow-hidden'>
                                        {mainImage ? (
                                            <img
                                                src={mainImage}
                                                alt={product.name}
                                                className={`w-full h-full object-contain ${(product.totalStock ?? 0) <= 0 ? 'opacity-60' : ''}`}
                                            />
                                        ) : (
                                        ...
                                        {(product.totalStock ?? 0) <= 0 && (
                                            <div className='absolute inset-0 flex items-center justify-center bg-black/40 rounded-xl'>
                                                <img
                                                    ...
                                                    alt='Hết hàng'
                                                    className='max-w-[70%] max-h-[60%] object-contain drop-shadow-lg'
                                                />
                                            </div>
                                        )}
                                    </div>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <div className='flex items-center gap-4 mb-6'>
                                        ...
                                        {product.oldPrice && <div className='text-lg text-gray-400 line-through'>{formatPrice(product.oldPrice)}</div>}
                                    </div>
                                        ...
                                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-sm'>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <span className='font-medium text-gray-900'>
                                                    {product.brandName || (typeof product.brand === 'object' ? product.brand?.name : product.brand) || 'N/A'}
                                                </span>
                                            </div>
                                            <div className='flex flex-col'>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <span className='font-medium text-gray-900'>
                                                    {product.usageDeviceName ||
                                                        (typeof product.usageDevice === 'object' ? product.usageDevice?.name : product.usageDevice) ||
                                                        'N/A'}
                                                </span>
                                            </div>
                                            <div className='flex flex-col'>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <span className='font-medium text-gray-900'>{product.originCountry?.trim() || 'N/A'}</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className='hidden xl:flex flex-col gap-4 border border-gray-100 rounded-xl p-5 bg-white shadow-sm w-[280px] flex-shrink-0 h-fit'>
                        <div className='flex items-start gap-3 border-b border-gray-200 pb-4'>
                            <div className='mt-1'>
                                ...
                                >
                                    <path
                                        d='M1 13H5.5L8.5 7H14.5L16 10H19L23 15V19H17C16.5 17.3 15 16 13.5 16C12 16 10.5 17.3 10 19H7.5C7 17.3 5.5 16 4 16C2.5 16 1 17.3 0 19V13H1Z'
                                        fill='currentColor'
                                    />
                                    <circle
                                        cx='4'
                        ...
                        <div className='flex items-start gap-3 border-b border-gray-200 py-3'>
                            <div className='mt-1'>
                                ...
                                >
                                    <path
                                        d='M21 15C21 18.3 18.3 21 15 21H9C5.7 21 3 18.3 3 15C3 11.7 5.7 9 9 9H15C18.3 9 21 11.7 21 15Z'
                                        stroke='currentColor'
                                        strokeWidth='2'
                                        strokeLinecap='round'
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className='flex-1 flex flex-col'>
                                            <h3 className='text-sm font-medium text-gray-800 line-clamp-2 min-h-[40px] group-hover:text-red-600 transition-colors'>{p.name}</h3>

                                            <div className='mt-auto pt-3'>
                                                <div className='flex items-end gap-2'>
                                                    <span className='text-red-600 font-bold text-lg'>{formatPrice(p.price)}</span>
                                                    {p.oldPrice && <span className='text-xs text-gray-400 line-through mb-1'>{formatPrice(p.oldPrice)}</span>}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
