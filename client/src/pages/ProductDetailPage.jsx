                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <Button 
                                        className="flex-1 py-6 text-lg bg-red-600 hover:bg-red-700 font-semibold"
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="flex-1 py-6 text-lg border-red-600 text-red-600 hover:bg-red-50 font-semibold"
